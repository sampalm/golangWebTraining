...
func login(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	...
	// 	json.NewEncoder(w).Encode("Password or email is empty")
	// 	return
	// }
	...
	found, role, err := LoginAccount(r, ud.Email, ud.Password)
	if found != true {
	...
	userSession.Values["email"] = ud.Email
