...
func CreateBottleCreated(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.BottleController, payload *app.CreateBottlePayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func DeleteBottleNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.BottleController, bottleID int) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
...
// DeleteBottleOK runs the method Delete of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func DeleteBottleOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.BottleController, bottleID int) (http.ResponseWriter, *app.Bottle) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListBottleOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.BottleController) (http.ResponseWriter, app.BottleCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowBottleOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.BottleController, bottleID int) (http.ResponseWriter, *app.Bottle) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
